...
const AboutUs = () => {
  return (
    <div className="tw-bg-white dark:tw-bg-slate-900 tw-p-10 tw-rounded-xl tw-shadow-2xl tw-mx-auto tw-max-w-6xl tw-mt-16 tw-mb-16">
      <h1 className="tw-text-5xl tw-font-extrabold tw-mb-8 tw-text-center tw-text-gray-800 dark:tw-text-gray-200">About Us</h1>
      <p className="tw-text-lg tw-text-gray-700 dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
        Welcome to <span className="tw-font-bold tw-text-orange-500">FoodHub</span>! We are passionate about bringing you the best culinary experiences from around the world. Whether you're craving Indian classics like Chole Bhature and Dosa, or delicious Italian pizzas, we have something to satisfy every palate.
      </p>
      <p className="tw-text-lg tw-text-gray-700 dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
      ...
      <p className="tw-text-lg tw-text-gray-700 dark:tw-text-gray-300 tw-mb-6 tw-leading-relaxed">
        Thank you for choosing <span className="tw-font-bold tw-text-orange-500">FoodHub</span>. We hope you have a delicious experience with us!
      </p>
      <div className="tw-flex tw-justify-center tw-mt-10">
        <img src={LOGO} alt="FoodHub Logo" className="tw-w-40 tw-h-40 tw-object-contain"/>
      </div>
